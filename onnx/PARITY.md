...
**148 / 198** standard operators implemented (74%).

Test results from the ONNX backend node test suite: **1275** pass, **59** fail, **344** skip (out of 1678 tests).
...
| RNN | Y | 3 pass, 1 skip | - | - |
| Resize | Y | 39 pass | - | - |
| RotaryEmbedding | Y | 8 pass | 6 pass, 2 fail | - |
